...
private:
	...
	void DrawNormals(const int& index, const Face& face, const MeshModel& model, const Camera& camera);
	void DrawNormalsVertics(const MeshModel& model, const Camera& camera);
